...
namespace Unary.Core
{
    ...
    public partial class UiCoreConsoleCounters : UiUnit<UiCoreState>
    {
        ...
        {
            _logCounter = Root.GetNode<MarginContainer>("%LogCounter");
            _logLabel = Root.GetNode<Label>("%LogCounterText");
            _logLabel.Text = "0";

            _warningCounter = Root.GetNode<MarginContainer>("%WarningCounter");
            _warningLabel = Root.GetNode<Label>("%WarningCounterText");
            _warningLabel.Text = "0";

            _errorCounter = Root.GetNode<MarginContainer>("%ErrorCounter");
            _errorLabel = Root.GetNode<Label>("%ErrorCounterText");
            _errorLabel.Text = "0";
