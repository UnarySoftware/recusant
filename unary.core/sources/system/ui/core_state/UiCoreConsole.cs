...
namespace Unary.Core
{
    ...
    public partial class UiCoreConsole : UiUnit<UiCoreState>
    {
        ...
        public override void Initialize()
        {
            ...
            _consoleHeader = Root.GetNode<MarginContainer>("%ConsoleHeader");

            _fontIncrease = Root.GetNode<MarginContainer>("%FontIncrease");
            _fontIncreaseButton = Root.GetNode<Button>("%FontIncreaseButton");
            _fontIncreaseButton.Pressed += () => { UpdateFont(FontChangePerClick); };

            _fontDecrease = Root.GetNode<MarginContainer>("%FontDecrease");
            _fontDecreaseButton = Root.GetNode<Button>("%FontDecreaseButton");
            _fontDecreaseButton.Pressed += () => { UpdateFont(-FontChangePerClick); };

            _close = Root.GetNode<MarginContainer>("%Close");
            _closeButton = Root.GetNode<Button>("%CloseButton");
            _closeButton.Pressed += () => { Toggle(); };

            _background = Root.GetNode<ColorRect>("%ConsoleBackground");
            _scroll = Root.GetNode<ScrollContainer>("%ConsoleScroll");
            _entries = Root.GetNode<VBoxContainer>("%ConsoleEntries");
