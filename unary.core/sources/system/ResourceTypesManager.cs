...
namespace Unary.Core
{
	...
	{
		public const string ManifestFile = "resource_types.tres";
		...
		{
			string targetPath = "res://" + modId + '/' + ManifestFile;

			if (!ResourceLoader.Singleton.Exists(targetPath, nameof(ResourceTypesManifest)))
			{
			...
			ResourceTypesManifest manifest = (ResourceTypesManifest)ResourceLoader.Singleton.Load(targetPath, nameof(ResourceTypesManifest));
