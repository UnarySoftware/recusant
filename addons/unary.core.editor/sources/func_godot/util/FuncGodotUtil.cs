...
namespace FuncGodot
{
    ...
    public static class FuncGodotUtil
    {
        ...
        /// <summary>
        /// Fallback albedo for faces whose texture is missing. This is the texture behind the
        /// <c>materials/dev/invalid.tres</c> material, not the material itself: the value feeds
        /// <see cref="BaseMaterial3D.AlbedoTexture"/> and must be a <see cref="Texture2D"/>.
        /// </summary>
        public const string DefaultTexturePath = "res://unary.core/materials/dev/invalid.png";
